# The ID of the agent.
TF_VAR_BEDROCK_AGENT_ID = "124"

# The ID of the agent alias. The default `TSTALIASID` will be used if it is not set.
TF_VAR_BEDROCK_AGENT_ALIAS_ID = "TSTALIASID"

# Teh default region for the agent. The default `us-east-1` will be used if it is not set.
